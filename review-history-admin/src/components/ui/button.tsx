...
const variants = {
  ...
  secondary: 'bg-surface text-foreground hover:bg-border/50 focus-visible:ring-border',
  ...
  ghost: 'text-muted hover:bg-surface hover:text-foreground focus-visible:ring-border',
