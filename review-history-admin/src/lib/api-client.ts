...
const ACCESS_TOKEN_STORAGE_KEY = 'reviewhistory:admin:access-token';
  ...
  async (error: AxiosError) => {
    ...
    if (
      ...
      try {
        ...
        clearAccessToken();
        emitWindowEvent(SESSION_EXPIRED_EVENT, { message: 'Your admin session has expired. Please log in again.' });
