...
const allowedImport = "@shared/field-limits";
...
if (violations.length > 0) {
  console.error('Invalid field-limits imports found in admin project:');
  for (const line of violations) console.error(`- ${line}`);
  process.exit(1);
}

console.log('Field-limits import check passed for admin.');
